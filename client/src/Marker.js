            ...
            <svg className='marker'
                ...
                <g>
                    <g transform="matrix(.25263 0 0 .25263 -3.0775 -5.2777)" fillRule="evenodd">
                        ...
                        <path className="marker-top" d="m50.271 34.396a13.229 13.229 0 0 1-13.173 13.229 13.229 13.229 0 0 1-13.285-13.116 13.229 13.229 0 0 1 13.059-13.341 13.229 13.229 0 0 1 13.397 13.002" />
